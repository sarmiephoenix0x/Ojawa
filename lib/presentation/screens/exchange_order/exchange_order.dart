...
import '../../controllers/exchange_order_controller.dart';
import '../exchange_order2/exchange_order2.dart';
...
class _ExchangeOrderState extends State<ExchangeOrder> {
  ...
  Widget build(BuildContext context) {
    final exchangeOrderController =
        Provider.of<ExchangeOrderController>(context);
                    ...
                    child: Column(
                      children: [
                        ...
                        Reason(
                          ...
                          value: 1,
                          controllerMethod:
                              exchangeOrderController.setSelectedRadioValue,
                          controllerVariable:
                              exchangeOrderController.selectedRadioValue!,
                        ),
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.02),
                        Reason(
                          text: "Received wrong product (color/size)",
                          value: 2,
                          controllerMethod:
                              exchangeOrderController.setSelectedRadioValue,
                          controllerVariable:
                        ...
                        SizedBox(
                            height: MediaQuery.of(context).size.height * 0.02),
                        Reason(
                          text: "Received defective product",
                          value: 3,
                          controllerMethod:
                              exchangeOrderController.setSelectedRadioValue,
                          controllerVariable:
                        ...
                        Padding(
                          ...
                          child: TextField(
                            controller:
                                exchangeOrderController.commentController,
                          ...
                          child: Row(
                            ...
                            children: [
                              SizeWidget(
                                text: 'S',
                                value: 1,
                                controllerMethod: exchangeOrderController
